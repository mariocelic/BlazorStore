...
namespace BlazorStore.Server.Migrations
{
    ...
    [Migration("20220826150233_ProductVariations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorStore.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorStore.Shared.ProductVariation", b =>
                {
            ...
            modelBuilder.Entity("BlazorStore.Shared.ProductVariation", b =>
                {
                    b.HasOne("BlazorStore.Shared.Product", "Product")
                        .WithMany("Variations")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorStore.Shared.ProductType", "ProductType")
                        .WithMany()
